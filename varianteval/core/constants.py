...
STRAND = Enum('STRAND', 'FWD REVERSE')
STRAND_ENCODING = {"+": STRAND.FWD, "-": STRAND.REVERSE}

# Genome annotation constants
REPEAT_TYPE = Enum('REPEAT_TYPE', 'SD SR SINE LINE MS VNTR ALL')

# Tools supported by the framework
SV_CALLER_TYPE = Enum('SV_CALLER_TYPE', 'GENERIC TRUTH_SET SNIFFLES PBSV CUTESV MANTA')
