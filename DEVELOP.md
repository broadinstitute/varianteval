...
varianteval is released automatically upon pushes to the main branch (generally by merging branches into main).  Automatic releases of varianteval consist of the following steps:
...
A PyPI distribution will be built automatically and uploaded to https://pypi.org/project/varianteval .
